                            ...
                            <div class="resp-tabs-container">
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                                    <div class="payment-info">
                                        ...
                                        <form>
                                            ...
                                            <a class="confirm-btn" href="success.php?m=<?php echo "cc";?>&oid=<?php echo$oid;?>&p=<?php echo$price?>">SEND</a>
                                        </form>
                                    </div>
                                </div>
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
                                    <div class="payment-info">
                                        ...
                                        <a class="confirm-btn" href="success.php?m=<?php echo "nb";?>&oid=<?php echo$oid;?>&p=<?php echo$price?>">CONTINUE</a>
                                    </div>
                                </div>
                                            ...
                                            <div class="user-login">
                                                ...
                                                <form>
                                                    ...
                                                    <div class="user-grids">
                                                        ...
                                                        <a class="confirm-btn" href="success.php?m=<?php echo "pp";?>&oid=<?php echo$oid;?>&p=<?php echo$price?>">LOGIN</a>
                                                        </div>
                                                        <div class="clear"></div>
                                                    </div>
                                                </form>
                                ...
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">
                                    <div class="payment-info">
                                        ...
                                        <form>
                                            ...
                                            <a class="confirm-btn" href="success.php?m=<?php echo "dc";?>&oid=<?php echo$oid;?>&p=<?php echo$price?>">SEND</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
